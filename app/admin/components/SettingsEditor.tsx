      ...
      <div className="admin-editor">
        <section className="admin-editor-panel">
          <div className="admin-field-grid">
            ...
            <label className="admin-field"><span>Contact email</span><input className="admin-input" value={settings.contactEmail || ""} onChange={(event) => update("contactEmail", event.target.value)} /></label>
